...
<div class="main-header">
    ...
    <p>Tác giả: Phàn Văn Hôn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 092 2872 403</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phàn Văn Hôn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 092 2872 403</div>", unsafe_allow_html=True)
